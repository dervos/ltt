...
public class BarChartTotal extends ApplicationFrame {

    public BarChartTotal(final String title) {
...
//        dataset.addValue(6.0, series3, category5);
    ...
    private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        final JFreeChart chart = ChartFactory.createBarChart(
            "Total Amount Of Passengers And Luggage",         // chart title
    ...
    public static void main(final String[] args) {
        ...
        final BarChartTotal demo = new BarChartTotal("Bar Chart Demo");
        demo.pack();
